...
bool Tgoniec::wsparcieSzachowania(Tpole** pola, Tpion** piony, int pozycja, bool ruch)
{
...
Tgoniec::Tgoniec(Tkoordynaty poz, int numer, bool team, int kto, const char* pathDoTexturki, const char* pathDoDzwiekuRuchu, const char* pathDoDzwiekuBicia) 
	: Tpion(poz, numer, team, kto, pathDoTexturki, pathDoDzwiekuRuchu, pathDoDzwiekuBicia)
{}

void Tgoniec::rysujSie()
{
	DrawTexture(tekstura, pozycja.x, pozycja.y, WHITE);
}

void Tgoniec::zaznaczanie(Tpole** tablicaPol, Tpion** tablicaPionow, int pozycja, jestSzach* jestszach, bool druzyna)
{
	if (pozycja == 0)               // lewy górny róg
	{
		doZaznaczania(tablicaPol, tablicaPionow, pozycja, druzyna, +9, jestszach);
	}
	else if (pozycja == 7)          // prawy górny róg
	{
		doZaznaczania(tablicaPol, tablicaPionow, pozycja, druzyna, +7, jestszach);
	}
...
void Tgoniec::szachowanieETC(Tpole** tablicaPol, Tpion** tablicaPionow, int pozycja, bool czyjRuch)
{
	if (czyjRuch == druzyna)
	{
		if (pozycja == 0)               // lewy górny róg
		{
			szachowanie(tablicaPol, tablicaPionow, pozycja, czyjRuch, +9);
		}
		else if (pozycja == 7)          // prawy górny róg
		{
			szachowanie(tablicaPol, tablicaPionow, pozycja, czyjRuch, +7);
		}
		else if (pozycja == 56)         // lewy dolny róg
		{
			szachowanie(tablicaPol, tablicaPionow, pozycja, czyjRuch, -7);
...
void Tgoniec::doZaznaczania(Tpole** tablicaPol, Tpion** tablicaPionow, int pozycja, bool czyjRuch, int wKtoraStrone, jestSzach* jestszach)
{
...
void Tgoniec::szachowanie(Tpole** tablicaPol, Tpion** tablicaPionow, int pozycja, bool czyjRuch, int wKtoraStrone)
{
